...
public class DCMotor implements ProtobufSerializable, StructSerializable {
  ...
  public double getCurrent(double speedRadiansPerSec, double voltageInputVolts) {
    double a = -1.0 / KvRadPerSecPerVolt / rOhms * speedRadiansPerSec;
    double b = 1.0 / rOhms * voltageInputVolts;
    double result = a + b;

    // double result = -1.0 / KvRadPerSecPerVolt / rOhms * speedRadiansPerSec + 1.0 / rOhms *
    // voltageInputVolts;
    return result;
  }
